...
{
    partial class CalendarPositionPanel
    {
        ImageBox wallpaper;
        ImageBox calendar;
        Button Button_1;
        ...
        private void InitializeWidget(LayoutOrientation orientation)
        {
            ...
            // calendar
            calendar.Image = new ImageAsset("/Application/assets/window.png");
            calendar.ImageScaleType = ImageScaleType.NinePatch;
            calendar.NinePatchMargin = new NinePatchMargin(16, 16, 16, 16);
        ...
        public void SetWidgetLayout(LayoutOrientation orientation)
        {
            switch (orientation)
            {
                case LayoutOrientation.Vertical:
                    ...
                    calendar.SetPosition(104, 301);
                    calendar.SetSize(200, 200);
                    calendar.Anchors = Anchors.None;
                ...
                default:
                    ...
                    calendar.SetPosition(0, 280);
                    calendar.SetSize(240, 192);
                    calendar.Anchors = Anchors.None;
                    calendar.Visible = true;
