...
namespace GameUI
{
    partial class UIHelpPanel
    {
        ...
        private void InitializeWidget(LayoutOrientation orientation)
        {
            ...
            // ImageBox_1
            ImageBox_1.Image = new ImageAsset("/Application/assets/menu_help.png");
        ...
        public void SetWidgetLayout(LayoutOrientation orientation)
        {
            switch (orientation)
            {
                case LayoutOrientation.Vertical:
                    ...
                    ImageBox_1.SetPosition(245, 167);
                ...
                default:
                    ...
                    ImageBox_1.SetPosition(248, 144);
                    ImageBox_1.SetSize(336, 168);
                    ImageBox_1.Anchors = Anchors.None;
                    ImageBox_1.Visible = true;
