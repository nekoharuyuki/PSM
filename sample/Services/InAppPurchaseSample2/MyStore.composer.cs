...
namespace Sample
{
    partial class MyStore
    {
        ...
        public void SetWidgetLayout(LayoutOrientation orientation)
        {
            switch (orientation)
            {
                ...
                default:
                    ...
                    Label_1.SetSize(491, 36);
                    Label_1.Anchors = Anchors.Top | Anchors.Height;
                    Label_1.Visible = true;

                    Label_2.SetPosition(94, 0);
                    Label_2.SetSize(377, 36);
                    Label_2.Anchors = Anchors.Top | Anchors.Height | Anchors.Left | Anchors.Right;
                    Label_2.Visible = true;

                    Label_3.SetPosition(473, 0);
                    Label_3.SetSize(164, 36);
                    Label_3.Anchors = Anchors.Top | Anchors.Height | Anchors.Right | Anchors.Width;
                    Label_3.Visible = true;

                    Label_4.SetPosition(639, 0);
                    Label_4.SetSize(101, 36);
                    ...
                    Button_1.SetSize(256, 56);
                    Button_1.Anchors = Anchors.Bottom | Anchors.Height;
                    Button_1.Visible = true;

                    Button_2.SetPosition(262, 316);
                    Button_2.SetSize(256, 56);
                    Button_2.Anchors = Anchors.Bottom | Anchors.Height;
                    Button_2.Visible = true;

                    Button_3.SetPosition(524, 316);
                    Button_3.SetSize(256, 56);
                    Button_3.Anchors = Anchors.Bottom | Anchors.Height;
                    Button_3.Visible = true;

                    Panel_1.SetPosition(37, 67);
        ...
        public void UpdateLanguage()
        {
            ...
            Button_1.Text = "Purchase";

            Button_2.Text = "Consume";
