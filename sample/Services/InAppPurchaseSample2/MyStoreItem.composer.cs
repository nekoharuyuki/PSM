        ...
        public void SetWidgetLayout(LayoutOrientation orientation)
        {
            switch (orientation)
            {
                ...
                default:
                    ...
                    CheckBox_1.SetPosition(12, 26);
                    CheckBox_1.SetSize(39, 39);
                    CheckBox_1.Anchors = Anchors.Height | Anchors.Left | Anchors.Width;
                    CheckBox_1.Visible = true;

                    Label_1.SetPosition(48, 28);
                    Label_1.SetSize(44, 36);
                    Label_1.Anchors = Anchors.Height | Anchors.Left | Anchors.Width;
                    Label_1.Visible = true;

                    Label_2.SetPosition(94, 14);
                    Label_2.SetSize(377, 64);
                    Label_2.Anchors = Anchors.Height | Anchors.Left | Anchors.Right;
                    Label_2.Visible = true;

                    Label_3.SetPosition(473, 28);
                    Label_3.SetSize(164, 36);
                    Label_3.Anchors = Anchors.Height | Anchors.Right | Anchors.Width;
                    Label_3.Visible = true;

                    Label_4.SetPosition(639, 28);
