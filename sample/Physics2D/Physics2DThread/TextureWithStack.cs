...
namespace Physics2DSample
{
    ...
    public class TextureWithStack : PhysicsScene
	{	
		...
		public void PerfCheck()
		{
			...
			{
				if(useThread)
					sceneName = "TextureWithStack[MultiThread]" + " " + "Total=" + totalPerf.ElapsedMilliseconds + "[ms]" + " Sim=" + timer + "[ms]";
				else
					sceneName = "TextureWithStack[SingleThread]" + " " + "Total=" + totalPerf.ElapsedMilliseconds + "[ms]" + " Sim=" + timer + "[ms]";
