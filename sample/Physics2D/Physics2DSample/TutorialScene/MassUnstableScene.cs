...
//
// Big difference of mass causes unstability of the simulation
//
...
// [Tips and notice]
//
// You can see that there are two stacks of boxes inside this sample.
// But the right one is unstable because the heavy object is on the light object
// and there is a big difference for the mass.
//
...
namespace Physics2DSample
{
    ...
    public class MassUnstableScene : PhysicsScene
	{	
		...
		public override void InitScene ()
        {
			...
			// Stable Stack (100.0Kg -> 10.0Kg -> 1.0Kg)
            // Create dynamic rigid sceneBodies
            {
                // Create a dynamic rigid body whose shape is box (100.0 Kg)
                {
                    sceneBodies[numBody] = new PhysicsBody(sceneShapes[2], 100.0f);
                    sceneBodies[numBody].position = new Vector2(-20.0f, -wall_height.Y + wall_width.Y + box_width.Y + 0.005f);
					sceneBodies[numBody].position += new Vector2(0f, (2 * 0 + 0.005f) * box_width.Y);
                    sceneBodies[numBody].shapeIndex = 2;
                    numBody++;
                }

                // Create a dynamic rigid body whose shape is box (10.0 Kg)
                {
                    sceneBodies[numBody] = new PhysicsBody(sceneShapes[2], 10.0f);
                    sceneBodies[numBody].position = new Vector2(-20.0f, -wall_height.Y + wall_width.Y + box_width.Y + 0.005f);
					sceneBodies[numBody].position += new Vector2(0f, (2 * 1 + 0.005f) * box_width.Y);
                    sceneBodies[numBody].shapeIndex =2;
                    numBody++;
                }
                ...
                // Create a dynamic rigid body whose shape is box (1.0 Kg)
                {
                    ...
                    sceneBodies[numBody].position = new Vector2(-20.0f, -wall_height.Y + wall_width.Y + box_width.Y + 0.005f);
					sceneBodies[numBody].position += new Vector2(0f, (2 * 2 + 0.005f) * box_width.Y);
                    sceneBodies[numBody].shapeIndex = 2;
                    numBody++;
                }
			}
		
			// Unstable Stack (1.0Kg -> 10.0Kg -> 100.0Kg)
            // Create dynamic rigid sceneBodies
            {
                // Create a dynamic rigid body whose shape is box (1.0 Kg)
                {
		...
		public override void InitScene ()
        {
            ...
            // Create dynamic rigid sceneBodies
            {
                // Create a dynamic rigid body whose shape is box (100.0 Kg)
                {
                    PhysicsBody body = AddBody(SceneShapes[2], 100.0f);
                    body.Position = new Vector2(-20.0f, -wall_height.Y + wall_width.Y + box_width.Y + 0.005f);
					body.Position += new Vector2(0f, (2 * 0 + 0.005f) * box_width.Y);
                }

                // Create a dynamic rigid body whose shape is box (10.0 Kg)
                {
                    PhysicsBody body = AddBody(SceneShapes[2], 10.0f);
                    body.Position = new Vector2(-20.0f, -wall_height.Y + wall_width.Y + box_width.Y + 0.005f);
					body.Position += new Vector2(0f, (2 * 1 + 0.005f) * box_width.Y);
                }
                ...
                // Create a dynamic rigid body whose shape is box (1.0 Kg)
                {
                    ...
                    body.Position = new Vector2(-20.0f, -wall_height.Y + wall_width.Y + box_width.Y + 0.005f);
					body.Position += new Vector2(0f, (2 * 2 + 0.005f) * box_width.Y);
                }
			}
