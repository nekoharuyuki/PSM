...
//
// Basic convex rigid body creation
//
...
// [Tips and notice]
//
// You can choose the way to create convex rigid body.
// One is the automatic creation of convex hull calculation.
// The other is the manual creation of convex by giving vertices directly.
// For the latter case, user should confirm that these vertices given actually construct the convex shape.
//
// It is good to choose the center of convex equals to (0, 0) (& center of gravity)
...
namespace Physics2DSample
{
    ...
    public class CreateConvexScene : PhysicsScene
	{	
		...
		public override void InitScene ()
        {
			...
			// The center of vertex points is moved to origin(0, 0) of local coordinate by CreateConvexHull()
			{
			...
			// Create a dynamic rigid body whose shape is convex (1.0 Kg)
			{
			...
			// Create a box for collision test
			{
			...
			// Create a sphere for collision test
			{
		...
		public override void InitScene ()
        {
			...
			// The center of vertex points is moved to origin(0, 0) of local coordinate by CreateConvexHull()
			{
            	...
            	AddConvexHullShape(rand_point, 10);
			}
