...
//
// different inertia tensor sample
//
...
namespace Physics2DSample
{
    ...
    public class ChangeTensorScene : PhysicsScene
	{	
		...
		public override void InitScene ()
        {
            ...
            // Create dynamic rigid sceneBodies
            {
                // Create a dynamic rigid body whose shape is box (1.0 Kg)
                {
					...
					sceneBodies[numBody].angularVelocity = 0.0f;
                    numBody++;
                }
                ...
                // Create a dynamic rigid body whose shape is box (1.0 Kg)
                {
					...
					// This box don't want to rotate too much
