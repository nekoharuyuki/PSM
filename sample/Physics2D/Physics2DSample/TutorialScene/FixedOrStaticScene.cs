...
// [Tips and notice]
//
// When the rigid body does not move from the start to the end at all,
// It is good to define this rigid body as a static one, 
// because it can reduce the calculation cost and can achieve the stability of the simulation.
//
...
namespace Physics2DSample
{
    ...
    public class FixedOrStaticScene : PhysicsScene
	{	
		...
		public override void InitScene ()
        {
            ...
            Vector2 box_width = new Vector2(10.0f, 2.0f);
            ...
            // Define the rigid body as static object
            {
			...
			// Define the rigid body and make the fixed joint to lock the motion of the rigid body
			// This is relatively unstable compared with static object (not to move at all)
            {
				...
				// Lock the movement and rotation
			...
			// To check the stability, give this sphere he mass
			sceneBodies[numBody] = new PhysicsBody(sceneShapes[3], 10.0f);
			sceneBodies[numBody].position = new Vector2(-15.0f, 15.0f);
			sceneBodies[numBody].shapeIndex = 3;
			numBody++;
			
			// To check the stability, give this sphere he mass
			sceneBodies[numBody] = new PhysicsBody(sceneShapes[3], 10.0f);
			sceneBodies[numBody].position = new Vector2(25.0f, 15.0f);	
			sceneBodies[numBody].shapeIndex = 3;
			numBody++;	
		...
		public override void InitScene ()
        {
			...
			{
				// To check the stability, give this sphere he mass
				PhysicsBody body = AddBody(SceneShapes[3], 10.0f);
				body.Position = new Vector2(-15.0f, 15.0f);
			}
			
			{
				// To check the stability, give this sphere he mass
				PhysicsBody body = AddBody(SceneShapes[3], 10.0f);
				body.Position = new Vector2(25.0f, 15.0f);
			}
