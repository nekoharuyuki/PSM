	...
	: Unit
{
	...
	public override bool Init()
	{
		...
		obj3d[0] = resContainer.GetObject3D( "A03L2" );
		...
		kind = Unit.KIND_DEF_HIGH_EXPLOSIVE;
	...
	public override void Update()
	{
		...
		if( changeModelLevel0 || changeModelLevel2 ){
			...
			if( changeModelLevel0 && modelLevel != 0 ){
				obj3d[0] = resContainer.GetObject3D( "A03L0" );
...
//			setCannonDir2Target( new Vector3( targetPos.X, targetPos.Y, targetPos.Z), 0.0f, 0.0f );
	...
	public void setCannonDir2Target( Vector3 trgPos, float rotX, float rotY )
	{
		...
		/// 向きを制御する根元のボーン
		baseMat = obj3d[0].model.Bones[GetBoneId( 0, "A03_y_axis" )].WorldMatrix;
		...
		{
		testMat = obj3d[0].model.Bones[GetBoneId( 0, "x_axis_scope_a" )].WorldMatrix;
		testMat = baseMat.Inverse() * testMat;
		testMat = baseRotMat * testMat;
		testMat.M41 = testMat.M41 + baseMat.M41;
		testMat.M42 = testMat.M42 + baseMat.M42;
		testMat.M43 = testMat.M43 + baseMat.M43;
		obj3d[0].model.Bones[GetBoneId( 0, "x_axis_scope_a" )].WorldMatrix = testMat;
		}


		/// Lgun_muzzle
		testMat = obj3d[0].model.Bones[GetBoneId( 0, "scope_a_scope_b" )].WorldMatrix;
		testMat = baseMat.Inverse() * testMat;
		testMat = baseRotMat * testMat;
		testMat.M41 = testMat.M41 + baseMat.M41;
		testMat.M42 = testMat.M42 + baseMat.M42;
		testMat.M43 = testMat.M43 + baseMat.M43;
		obj3d[0].model.Bones[GetBoneId( 0, "scope_a_scope_b" )].WorldMatrix = testMat;

		/// Lgun_Lgun_MA
		testMat = obj3d[0].model.Bones[GetBoneId( 0, "x_axis_joint_a" )].WorldMatrix;
		testMat = baseMat.Inverse() * testMat;
		testMat = baseRotMat * testMat;
		testMat.M41 = testMat.M41 + baseMat.M41;
		testMat.M42 = testMat.M42 + baseMat.M42;
		testMat.M43 = testMat.M43 + baseMat.M43;
		obj3d[0].model.Bones[GetBoneId( 0, "x_axis_joint_a" )].WorldMatrix = testMat;


		/// Lgun_b_rot_Lgun_b_MA
		testMat = obj3d[0].model.Bones[GetBoneId( 0, "joint_a_barrel_a" )].WorldMatrix;
		testMat = baseMat.Inverse() * testMat;
		testMat = baseRotMat * testMat;
		testMat.M41 = testMat.M41 + baseMat.M41;
		testMat.M42 = testMat.M42 + baseMat.M42;
		testMat.M43 = testMat.M43 + baseMat.M43;
		obj3d[0].model.Bones[GetBoneId( 0, "joint_a_barrel_a" )].WorldMatrix = testMat;

				
		/// Lgun_b_muzzle
		testMat = obj3d[0].model.Bones[GetBoneId( 0, "barrel_a_joint_b" )].WorldMatrix;
		testMat = baseMat.Inverse() * testMat;
		testMat = baseRotMat * testMat;
		testMat.M41 = testMat.M41 + baseMat.M41;
		testMat.M42 = testMat.M42 + baseMat.M42;
		testMat.M43 = testMat.M43 + baseMat.M43;
		obj3d[0].model.Bones[GetBoneId( 0, "barrel_a_joint_b" )].WorldMatrix = testMat;

				
		/// Lgun_b_muzzle
		testMat = obj3d[0].model.Bones[GetBoneId( 0, "joint_b_barrel_b" )].WorldMatrix;
		testMat = baseMat.Inverse() * testMat;
		testMat = baseRotMat * testMat;
		testMat.M41 = testMat.M41 + baseMat.M41;
		testMat.M42 = testMat.M42 + baseMat.M42;
		testMat.M43 = testMat.M43 + baseMat.M43;
		obj3d[0].model.Bones[GetBoneId( 0, "joint_b_barrel_b" )].WorldMatrix = testMat;

				
		/// Lgun_b_muzzle
		testMat = obj3d[0].model.Bones[GetBoneId( 0, "barrel_b_muzzle" )].WorldMatrix;
		testMat = baseMat.Inverse() * testMat;
		testMat = baseRotMat * testMat;
		testMat.M41 = testMat.M41 + baseMat.M41;
		testMat.M42 = testMat.M42 + baseMat.M42;
		testMat.M43 = testMat.M43 + baseMat.M43;
		obj3d[0].model.Bones[GetBoneId( 0, "barrel_b_muzzle" )].WorldMatrix = testMat;
				
				
		/// Lgun_b_muzzle
		if( modelLevel == Unit.MODEL_LEVEL_HIGH || modelLevel == Unit.MODEL_LEVEL_NORMAL )
		{
		testMat = obj3d[0].model.Bones[GetBoneId( 0, "joint_b_joint_b_MA" )].WorldMatrix;
		testMat = baseMat.Inverse() * testMat;
		testMat = baseRotMat * testMat;
		testMat.M41 = testMat.M41 + baseMat.M41;
		testMat.M42 = testMat.M42 + baseMat.M42;
		testMat.M43 = testMat.M43 + baseMat.M43;
		obj3d[0].model.Bones[GetBoneId( 0, "joint_b_joint_b_MA" )].WorldMatrix = testMat;
		}
		...
		if( modelLevel == Unit.MODEL_LEVEL_HIGH || modelLevel == Unit.MODEL_LEVEL_NORMAL )
		{
		testMat = obj3d[0].model.Bones[GetBoneId( 0, "joint_a_joint_a_MA" )].WorldMatrix;
		testMat = baseMat.Inverse() * testMat;
		testMat = baseRotMat * testMat;
		testMat.M41 = testMat.M41 + baseMat.M41;
		testMat.M42 = testMat.M42 + baseMat.M42;
		testMat.M43 = testMat.M43 + baseMat.M43;
		obj3d[0].model.Bones[GetBoneId( 0, "joint_a_joint_a_MA" )].WorldMatrix = testMat;
		}
		...
		obj3d[0].model.Bones[GetBoneId( 0, "A03_y_axis" )].WorldMatrix = baseMat;
	}
