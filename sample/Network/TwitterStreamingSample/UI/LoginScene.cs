        ...
        public LoginScene()
        {
            ...
            this.m_TitlePanel.ButtonLogin.ButtonAction +=
                (object sender, TouchEventArgs e) =>
                {
                    ...
                    if ((String.IsNullOrEmpty(TwitterStreamingSample.Application.TWITTER_CONSUMER_KEY)) || 
                        (String.IsNullOrEmpty(TwitterStreamingSample.Application.TWITTER_CONSUMER_SECRET)))
                    {
                        var consumerDialog = new TwitterStreamingSample.ConsumerDialog();
