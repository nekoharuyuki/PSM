...
namespace TwitterStreamingSample
{
	public class TwitterUserProfileImageCacheStore
	{
		...
		private System.Collections.Generic.Dictionary<string, object> m_Dictionary = 
		new System.Collections.Generic.Dictionary<string, object>();
		
		public TwitterUserProfileImageCacheStore ()
		{ }
		...
		public void RequestCache(StreamInfo stList, Action<Image> response)
		{
			var screenName = stList.ScreenName;
			var extension = System.IO.Path.GetExtension(stList.ProfileImgUrl);
			var fileName = screenName + ".png";
			...
			{
				var request = new System.Net.HttpWebRequest(new System.Uri(stList.ProfileImgUrl));
