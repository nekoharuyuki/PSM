...
namespace TwitterSample.UserInterface
{
    partial class FeedListPanelItem
    {
        ...
        private void InitializeWidget(LayoutOrientation orientation)
        {
            ...
            // FeedListPanelItem
            this.BackgroundColor = new UIColor(128f / 255f, 128f / 255f, 128f / 255f, 0f / 255f);
            ...
            m_LabelText.Font = new UIFont(FontAlias.System, 19, FontStyle.Regular);
        ...
        public void SetWidgetLayout(LayoutOrientation orientation)
        {
            switch (orientation)
            {
                case LayoutOrientation.Vertical:
                    this.SetSize(544, 220);
                    this.Anchors = Anchors.None;

                    m_ImageBox.SetPosition(3, 2);
                    m_ImageBox.SetSize(79, 79);
                    m_ImageBox.Anchors = Anchors.None;
                    m_ImageBox.Visible = true;

                    m_LabelUserName.SetPosition(85, 2);
                    m_LabelUserName.SetSize(214, 30);
                    m_LabelUserName.Anchors = Anchors.None;
                    m_LabelUserName.Visible = true;

                    m_LabelText.SetPosition(85, 55);
                    m_LabelText.SetSize(457, 165);
                    m_LabelText.Anchors = Anchors.None;
                    m_LabelText.Visible = true;

                    m_LabelUserScreenName.SetPosition(85, 31);
                    m_LabelUserScreenName.SetSize(214, 25);
                    m_LabelUserScreenName.Anchors = Anchors.None;
                    m_LabelUserScreenName.Visible = true;

                    m_LabelDateTime.SetPosition(299, 2);
                    m_LabelDateTime.SetSize(243, 36);
                ...
                default:
                    ...
                    m_ImageBox.SetPosition(2, 2);
                    m_ImageBox.SetSize(96, 96);
                    m_ImageBox.Anchors = Anchors.None;
                    m_ImageBox.Visible = true;

                    m_LabelUserName.SetPosition(100, 0);
                    m_LabelUserName.SetSize(420, 30);
                    m_LabelUserName.Anchors = Anchors.None;
                    m_LabelUserName.Visible = true;

                    m_LabelText.SetPosition(100, 55);
                    m_LabelText.SetSize(850, 146);
                    m_LabelText.Anchors = Anchors.None;
                    m_LabelText.Visible = true;

                    m_LabelUserScreenName.SetPosition(100, 30);
