...
#define SAMPLEMODULE	MdxModule_ImportXSI
...
class SAMPLEMODULE : public MdxModule {
	...
	virtual const char *GetModuleName() const { return "ImportXSI" ; }
	virtual const char *GetModuleVersion() const { return "1.00" ; }
	virtual const char *GetModuleCopyright() const { return "(c) SCEI" ; }
	virtual const char *GetModuleDescription() const { return "XSI Importer" ; }
