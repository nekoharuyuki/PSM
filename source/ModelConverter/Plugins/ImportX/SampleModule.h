...
#define SAMPLEMODULE	MdxModule_ImportX
...
class SAMPLEMODULE : public MdxModule {
	...
	virtual const char *GetModuleName() const { return "ImportX" ; }
	virtual const char *GetModuleVersion() const { return "1.00" ; }
	virtual const char *GetModuleCopyright() const { return "(c) SCEI" ; }
	virtual const char *GetModuleDescription() const { return "X Importer" ; }
