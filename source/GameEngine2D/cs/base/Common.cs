...
//		[Conditional("DEBUG")]
		...
		public static 
		int Min( int i, int value )
		{
			return i<value?i:value;
		}

		public static 
		int Max( int i, int value )
		{
			return i>value?i:value;
		}
		...
		/// @endif
		static 
		public System.Byte[] GetEmbeddedResource( string filename )
		{
//			System.Console.WriteLine( "GetEmbeddedResource("+filename+")" );
			...
			string embedded_filename = "Sce.PlayStation.HighLevel.GameEngine2D." + filename.Replace("/", ".");
...
//				System.Console.WriteLine( "Found embedded file: " + filename );
		...
		static 
		public Sce.PlayStation.Core.Graphics.ShaderProgram CreateShaderProgram( string filename )
		{
...
//			ret = new Sce.PlayStation.Core.Graphics.ShaderProgram( filename );
		...
		static 
			public void DisposeAndNullify< T >( ref T a )
		{
			if ( a == null )
				return;
